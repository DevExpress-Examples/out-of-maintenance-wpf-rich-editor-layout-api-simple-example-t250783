...
Namespace LayoutAPISimpleExample
    ...
    Friend Class MyLayoutPainter
        ...
        Public Overrides Sub DrawFloatingPicture(ByVal floatingPicture As LayoutFloatingPicture)
            ...
            Dim startPoint As New Point(bounds.X + Canvas.ConvertToDrawingLayoutUnits(40, DocumentLayoutUnit.Pixel), bounds.Y + bounds.Height - Canvas.ConvertToDrawingLayoutUnits(120, DocumentLayoutUnit.Pixel))
